...
This is a wrapper for the Hawki framework to support API requests against it, as for now HAWKI only provides a Web UI.
...
HAWKI_API_URL=HAWKI_API_URL # the Hawki Web UI endpoint, defaults to https://hawki2.htwk-leipzig.de/
```
